...
const MOCK_INCIDENTS: Incident[] = [
  {
    id: 'INC-782',
    cameraId: '2',
    cameraName: 'Inventory Gate B',
    type: 'Unrecognized Movement',
    timestamp: '2026-04-28 07:45:12',
    evidenceUrl: 'https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&q=80&w=1200',
    severity: 'high'
  },
  {
    id: 'INC-781',
    cameraId: '1',
    cameraName: 'Robotic Arm Area 1',
    type: 'Collision Detected',
    timestamp: '2026-04-28 05:22:01',
    evidenceUrl: 'https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&q=80&w=1200',
    severity: 'medium'
  },
  {
    id: 'INC-779',
    cameraId: '3',
    cameraName: 'Main Assembly Line',
    type: 'Process Deviation',
    timestamp: '2026-04-27 23:10:55',
    evidenceUrl: 'https://images.unsplash.com/photo-1504917595217-d4dc5f639c4a?auto=format&fit=crop&q=80&w=1200',
    severity: 'low'
  }
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
              ...
              {MOCK_INCIDENTS.map((incident) => (
                <tr key={incident.id} className="hover:bg-gray-50/50 transition-colors group">
                  <td className="px-6 py-6">
                    ...
                    >
                      <img src={incident.evidenceUrl} alt="Evidence" className="w-full h-full object-cover" />
          ...
          <div className="p-6 bg-gray-50/50 border-t border-gray-100 flex justify-between items-center">
            <p className="text-sm text-gray-500 font-medium">Showing 1-3 of 42 incidents</p>
